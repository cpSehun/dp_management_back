"""
User 도메인 라우터
기존 app/routers/users.py를 이동하고 import 경로 수정
"""
...
def read_current_user_info(current_user: models.User = Depends(get_current_active_user)):
    """현재 로그인한 사용자 정보 조회"""
    return current_user
...
def update_user_status(
    ...
    is_active: bool,
    db: Session = Depends(get_db),
    current_user: models.User = Depends(get_current_active_superuser)  # 최고관리자만
):
